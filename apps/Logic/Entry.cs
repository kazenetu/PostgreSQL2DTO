...
namespace Logic
{
  ...
  public class Entry
  {
    ...
    public static void CreateSources(string nameSpace, string outputPath, string hostName, string userID, string password, string database, int port = 5432)
    {
      ...
      foreach (var table in tables)
      {
        ...
        Generator.Generate(table, outputPath, nameSpace);
        Console.WriteLine("ok");
      }
